#!/bin/bash
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%35s%s%-20s\n' "VPS Setup 1 (VPS Manager 2.0.1 + Patch )" ; tput sgr0
...
echo "● Configurar o OpenSSH para rodar nas portas 22, 143 e 443"
...
echo ""
echo "Ao utilizar o 'VPS Setup' você concorda com os seguintes termos de uso:"
echo ""
echo "1. Você pode:"
echo "a. Instalar e usar o 'VPS Setup' no(s) seu(s) servidor(es)."
echo "b. Criar, gerenciar e remover um número ilimitado de usuários através desse conjunto de scripts."
echo ""
tput setaf 3 ; tput bold ; read -n 1 -s -p "Aperte qualquer tecla para continuar..." ; echo "" ; echo "" ; tput sgr0
echo "2. Você aceita que:"
echo "a. O valor pago (se for o caso) por esse conjunto de scripts INCLUI garantias ou suportes adicionais."
echo "Salve em casos onde o usuário não está pagando, que nesse contexto, poderá reivindicar suporte,"
echo "E reportar problemas com o script. Porém sem nenhuma obrigação legal, seja ela de qual natureza for."
...
echo ""
echo "Créditos: Phreaker56, criador do antigo VPS Manager."
tput setaf 3 ; tput bold ; read -n 1 -s -p "Aperte qualquer tecla para continuar..." ; echo "" ; echo "" ; tput sgr0
...
then
	...
	wget https://scripts.zrcloud.xyz/vpsmanager/squid2.txt -O /tmp/sqd3
	cat /tmp/sqd1 /tmp/sqd2 /tmp/sqd3 > /etc/squid3/squid.conf
	wget https://scripts.zrcloud.xyz/vpsmanager/payload.txt -O /etc/squid3/payload.txt
